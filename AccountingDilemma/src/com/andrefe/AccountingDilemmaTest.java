...
public class AccountingDilemmaTest {
	...
	List<Integer> results = new AccountingDilemma().computeSequenceIterative(operations, balance);
    ...
    @Test
    public void testFile9_ERR_NegativeBigBalance() throws IOException {
	
	String inputPath = "res/input9.txt";
	String outputPath = "res/output9.txt";
